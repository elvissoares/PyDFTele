...
if __name__ == "__main__":
    ...
    if test2:
        ...
        var = np.log(n)
        # [varsol,Omegasol,Niter] = optimize_anderson(var,rhofunc,Omega,dOmegadnR,mu,beta=0.02,atol=1e-9,logoutput=True)
        ...
        name = 'MCdata/hardwall-mixture-eta0.12-x1_0.83-ratio3'
        data = np.loadtxt(name+'-small.dat')
        [xdata, rhodata] = [data[:,0],data[:,1]]
        plt.scatter(xdata,rhodata,marker='o',edgecolors='C0',facecolors='none',label='MC')
